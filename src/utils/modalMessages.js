const modalMessages = (systolic, diastolic, pulse) => {
    if(systolic >= 180 || diastolic >= 120) {
        ...
        return {
            title: 'Data set successfully', 
            message: 'Beware! These measurements indicate that you are in a state called Hypertension Stage II. Your blood pressure is highly elevated. Try to relax and calm yourself and do consider a visit to your health provider in the next few days!'}
